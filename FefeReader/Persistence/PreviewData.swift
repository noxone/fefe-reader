...
class PreviewData {
    ...
    private init() {
        ...
        // Create data
        preview_internal_BlogEntries.append(preview_createBlogEntry(id: 1, teaser: "This is an unread teaser.", read: false, bookmark: false))
        preview_internal_BlogEntries.append(preview_createBlogEntry(id: 2, teaser: "This is another teaser, but read.", read: true, bookmark: false))
        preview_internal_BlogEntries.append(preview_createBlogEntry(id: 3, teaser: "Unread: This is some more text that is really long and does not fit into one single line.", read: false, bookmark: true))
        preview_internal_BlogEntries.append(preview_createBlogEntry(id: 4, teaser: "Read: And a fourth one... This one also has quite a long teaser text.", read: true, bookmark: false))
